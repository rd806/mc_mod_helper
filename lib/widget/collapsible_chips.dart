    ...
    Widget build(BuildContext context) {
        ...
        return LayoutBuilder(
            builder: (context, constraints) {
                ...
                if (_measured && (_measuredWidth != constraints.maxWidth || _measuredScale != scale)) {
                ...
                final visible = !_measured ? const SizedBox.shrink() : _buildVisibleLayer();
                ...
                ClipRect(
                    child: ConstrainedBox(
                        constraints: BoxConstraints(
                            maxHeight: (_expanded || !_overflow) ? double.infinity : _twoLineHeight,
                        ),
                        child: _buildWrap(),
                      ),
                  ),
