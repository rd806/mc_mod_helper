      ...
      builder: (context, _) {
        return MaterialApp(
          ...
          theme: _buildTheme(
            ...
            ThemeSettings.instance.fontFamily,
          ),
...
///
/// [fontFamily] 为 null 表示用系统字体(见 ThemeSettings.fontFamily)
ThemeData _buildTheme(
  ...
  return _themeCache.putIfAbsent(
    // Web 端不参与字体切换,键里用占位符
    (seedColor.toARGB32(), brightness, kIsWeb ? '' : fontFamily),
    () {
      return ThemeData(
