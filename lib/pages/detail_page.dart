...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget _buildDetail(ModDetail mod) {
        ...
        children: [
            ...
            const SizedBox(height: 12),
            Text('模组介绍', style: theme.textTheme.titleMedium),
            const SizedBox(height: 4),
            ...
            Text('相关链接', style: theme.textTheme.titleMedium),
            const SizedBox(height: 8),
            Wrap(
                spacing: 8,
                runSpacing: 8,
            ...
            const SizedBox(height: 16),
            Text('支持的 MC 版本', style: theme.textTheme.titleMedium),
            const SizedBox(height: 8),
            Wrap(
                spacing: 8,
                runSpacing: 8,
            ...
            label: const Text('在浏览器中打开 MC百科 页面'),
            ),
        ],
        );
    }
